...
quaterntions1 = []
timestamp1 = []
with open(filepath + '/imu_int_pose_Euler.txt', 'r') as f:  # imu_pose   imu_spline
...
quaterntions2 = []
timestamp2 = []
with open(filepath + '/imu_int_pose_MidPoint.txt', 'r') as f:  # cam_pose_opt_o_0   cam_pose_opt_o_0
...
xyz2 = zip(*position2)
print
ax.plot(xyz[0], xyz[1], xyz[2],'ro', label='ground truth') #color='r',
