...
quaterntions1 = []
timestamp1 = []
with open(filepath + '/imu_int_pose_noise_Euler.txt', 'r') as f:  # imu_pose   imu_spline
...
quaterntions2 = []
timestamp2 = []
with open(filepath + '/imu_int_pose_noise_MidPoint.txt', 'r') as f:  # cam_pose_opt_o_0   cam_pose_opt_o_0
...
xyz3 = zip(*position3)
print
ax.plot(xyz3[0], xyz3[1], xyz3[2],'ro', label='noise')
ax.plot(xyz[0], xyz[1], xyz[2], label='ground truth',color='k') #color='r',
ax.plot(xyz1[0], xyz1[1], xyz1[2], label='Euler integral',color='g')
ax.plot(xyz2[0], xyz2[1], xyz2[2], label='MidPoint integral',color='b')
ax.legend()
