...
public:
    ...
    void PubFeatureData(double dStampSec, const vector<int> ids, /*const vector<Vector3d> landmarks,*/ const vector<Vector2d> feature_positions_un, const vector<Vector2d> feature_positions, const vector<Vector2d> feature_velocities);
